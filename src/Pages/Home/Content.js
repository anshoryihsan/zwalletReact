                                    ...
                                    <article className="  ">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between my-3">
                                            <div className="d-flex align-items-center">
                                                <img src="/assets/img/user-photo.svg" alt="img" />
                                                <div className="ml-2 pl-2 flex-row">
                                                    <span className="p-1 font-weight-bold small">Samuel Suhi</span>
                                        ...
                                        <div className="d-flex align-items-center justify-content-between py-3">
                                            <div className="d-flex align-items-center">
                                                <img src="/assets/img/user-photo.svg" alt="img" />
                                                <div className="ml-2 pl-2 flex-row">
                                                    <span className="p-1 font-weight-bold small">Netflix</span>
                                                    <span className="p-1 small">Subsription</span>
                                                </div>
                                            </div>
                                            <span className="txt-red small">- Rp149.000</span>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-between my-3">
                                            <div className="d-flex align-items-center">
                                                <img src="/assets/img/user-photo.svg" alt="img" />
